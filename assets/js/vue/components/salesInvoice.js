            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 text-right">
                        ...
                        <strong>Approve by:</strong> {{ sales.ApproveBy }} <br>
                        <strong>Delevered by:</strong> {{ sales.Employee_Name }}
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <body>
                             <div class="row">
                                <div class="col-xs-6"> 
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-10" style="padding-top:15px;">
                                                            <strong style="font-size:16px;">${this.currentBranch.Company_Name}</strong><br>
                                                            <p style="white-space:pre-line;">${this.currentBranch.Repot_Heading}</p>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-xs-12">
                                                            <div style="border-bottom: 4px double #454545;margin-top:2px;margin-bottom:1px;"></div>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                    ...
                                    <div class="row" style="margin-bottom:3px;padding-bottom:5px;">
                                        <div class="col-xs-6">
                                            <span style="text-decoration:overline;">Customer Signature</span><br><br>
                                        </div>
                                        <div class="col-xs-6 text-right">
                                            <span style="text-decoration:overline;">Authorized by</span>
                                        </div>
                                    </div>
                                        <div style="position:fixed;left:0;bottom:25px;width:50%;">
                                            <div class="row" style="font-size:8px;">
                                                <div class="col-xs-12 text-center">
                                                    <strong>  উপরের উল্লেখিত ক্রয়কৃত পণ্যের বকেয়া মূল্য আমার চলতি মাসের বেতন হতে সমন্বয়/কর্তন করা হবে, ইহা জানিয়া বুঝিয়া স্বাক্ষর করিলাম</strong>
                                                </div>
                                            </div>
                                        </div>

                                            <div style="position:fixed;left:0;bottom:10px;width:50%;">
                                                <div class="row" style="font-size:8px;">
                                                    <div class="col-xs-6">
                                    ...
                                    <thead>
                                        <tr>
                                            <td>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <div style="border-bottom: 4px double #454545;margin-top:5px;margin-bottom:3px;"></div>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                ...
                                <div class="row" style="margin-bottom:3px;padding-bottom:3px;">
                                    <div class="col-xs-6">
                                    ...
                                    <div style="position:fixed;right:0;bottom:10px;width:50%;">
                                        <div class="row" style="font-size:8px;">
