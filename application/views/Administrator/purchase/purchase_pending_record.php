                        ...
                        <template v-for="purchase in purchases">
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    ...
                                    <a v-if="purchase.status == 'p'" href="" title="Approve"
                                        @click.prevent="approveItem(purchase.PurchaseMaster_SlNo)"><i
                                            style="font-size:18px" class="fa fa-check-square"></i></a>
                            ...
                            <tr :style="{background: purchase.status == 'p' ? 'rgb(255 251 220)' : ''}">
                                ...
                                <td style="text-align:center;">
                                    <a href="" title="Purchase Invoice"
                                        ...
                                        target="_blank"><i class="fa fa-file-text"></i></a>
                                    <?php if ($this->session->userdata('accountType') != 'u') { ?>
                                    <a href="" title="Approve" @click="approveItem(purchase.PurchaseMaster_SlNo)"><i
                                            style="font-size:18px" class="fa fa-check-square"></i></a>
                                    <a href="javascript:" title="Edit Purchase" @click="checkReturnAndEdit(purchase)"><i
                                            class="fa fa-edit"></i></a>
                                    <a href="" title="Delete Purchase"
        ...
        getPurchaseRecord() {
            ...
            axios.post(url, filter)
                .then(res => {
                    ...
                    this.purchases = res.data.purchases.filter((p) => {
                        return p.status == 'p';
                    });
