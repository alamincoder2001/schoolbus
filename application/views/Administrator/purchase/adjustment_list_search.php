	...
	<table class="border" cellspacing="0" cellpadding="0" border="0" id="" style="width:80%;border-collapse:collapse;">
		<thead>
			<tr class="header" style="background:#ccc;">
				...
				<th style="text-align:center;">Adjustment Quantity</th>
		...
		?>
			<tr align="center">
				...
				<td><?php echo $record->AdjustmentDetails_AdjustmentQuantity; ?></td>
				<td><?php echo $record->Unit_Name; ?></td>
				<td><?php echo $record->adjustment_type; ?></td>
				<td><?php echo $record->Adjustment_Description; ?></td>
			</tr>
		<?php } }?>                 
		</tbody>
	</table>                    
