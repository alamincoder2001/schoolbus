    ...
    new Vue({
        ...
        data(){
            return {
                ...
                adjustments: [],
				columns: [
                    { label: 'Code', field: 'Adjustment_InvoiceNo', align: 'center', filterable: false },
                    { label: 'Date', field: 'Adjustment_Date', align: 'center' },
                    { label: 'Product Code', field: 'Product_Code', align: 'center' },
                    { label: 'Product Name', field: 'Product_Name', align: 'center' },
                    { label: 'Adjustment Type', field: 'adjustment_type', align: 'center' },
                    { label: 'Quantity', field: 'AdjustmentDetails_AdjustmentQuantity', align: 'center' },
                    { label: 'Adjustment Rate', field: 'adjustment_rate', align: 'center' },
                    { label: 'Adjustment Amount', field: 'adjustment_amount', align: 'center' },
                    { label: 'Description', field: 'Adjustment_Description', align: 'center' },
