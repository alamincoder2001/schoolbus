        ...
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="sales">
                    ...
                    <li><input type="checkbox" class="access" value="salesPending" v-model="access"> Sales Pending</li>
            ...
            <div class="group">
                ...
                <ul ref="accounts">
                    ...
                    <li><input type="checkbox" class="access" value="customerPaymentPageExcel" v-model="access"> Customer Payment Excel</li>
        ...
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="purchase">
                    ...
                    <li><input type="checkbox" class="access" value="purchasePendingRecord" v-model="access"> Purchase Pending</li>
        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="admin">
                    ...
                    <li><input type="checkbox" class="access" value="adjustmentEntry" v-model="access"> Adjustment Entry</li>
                    <li><input type="checkbox" class="access" value="adjustmentList" v-model="access"> Adjustment List</li>
                    ...
                    <li><input type="checkbox" class="access" value="customerEntry" v-model="access"> Customer Entry</li>
