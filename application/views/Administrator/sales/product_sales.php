...
<div id="sales" class="row">
    <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
        <div class="row">
            ...
            <div class="form-group">
                <label class="col-sm-1 control-label no-padding-right"> Delevery By </label>
                <div class="col-sm-2">
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <v-select style="float:left;width:87%" v-bind:options="months" label="month_name" v-model="selectedMonth"></v-select>
                    <a style="float:right;width:13%" href="/month" target="_blank" class="add-button">
                ...
                <div class="widget-main">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                <div class="col-xs-6">
                                    <span style="font-weight:bold; color:green">Total Limit : </span>
                                    <strong> {{creditLimit.Customer_Credit_Limit}}</strong>
                                </div>
                                <div class="col-xs-6">
                                    <span style="font-weight:bold; color:green">Current Limit </span>
                                    <strong> {{creditLimit.currentCreditLimit}} </strong>
                                </div>
                            </div>
                        </div>
    ...
    new Vue({
        ...
        data() {
            return {
                ...
                currentMonth: "<?php echo date("F-Y"); ?>",
                productPurchaseRate: '',
                productStockText: '',
                productStock: '',
        ...
        watch: {
            months() {
                this.months.forEach(m => {
                    if (this.currentMonth == m.month_name) {
                        this.selectedMonth = {
                            month_id: m.month_id,
        ...
        methods: {
                ...
                axios.post('/get_products', {
                    ...
                    if (this.sales.salesType == 'wholesale') {
                        ...
                        this.products = res.data.map(p => {
                            p.display_text = p.Supplier_Name + ' - ' + p.display_text
                            return p;
                        });
                    }
                })
            ...
            async customerOnChange() {
                ...
                if (this.selectedCustomer.Customer_Type != "G") {
                    ...
                    await this.getCustomerCreditLimit();
                }
                this.calculateTotal();
            },
            ...
            async getCustomerCreditLimit() {
                await axios.post('/get_customer_credit_limit', {
                    customerId: this.selectedCustomer.Customer_SlNo
                }).then(res => {
                    this.creditLimit = res.data[0];
                })
            },
            ...
            async saveSales() {
                ...
                this.sales.month_id = this.selectedMonth.month_id;
