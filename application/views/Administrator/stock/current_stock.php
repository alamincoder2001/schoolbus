        ...
        <div class="col-md-12">
            <div class="table-responsive" id="stockContent">
                ...
                <table class="table table-bordered"
                    v-if="searchType != 'current' && searchType != 'supplier'  && searchType != null"
                    style="display:none;"
                ...
                <table class="table table-bordered" v-if="searchType == 'supplier'" style="display:none"
