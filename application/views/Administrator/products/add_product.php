		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom: 15px;">
			<div class="col-md-6">
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-1" style="padding:0;margin-left: -15px;"><a href="/supplier" target="_blank" class="add-button"><i class="fa fa-plus"></i></a></div>
				</div>
	...
	new Vue({
		...
		methods: {
			...
			saveProduct() {
				...
				this.product.supplier_id = this.selectedSupplier.Supplier_SlNo;
			...
			editProduct(product) {
				...
				this.selectedSupplier = {
					Supplier_SlNo: product.supplier_id,
					display_name: product.supplier_text,
				}
			},
