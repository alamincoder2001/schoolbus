...
<?php } elseif ($module == 'Administration') { ?>
    <ul class="nav nav-list">
        ...
        <?php endif; ?>
        <?php if (
            array_search("adjustmentEntry", $access) > -1
            || array_search("adjustmentList", $access) > -1
            || isset($CheckSuperAdmin) || isset($CheckAdmin)
        ) : ?>
            <li class="">
                <a href="<?php echo base_url(); ?>" class="dropdown-toggle">
                    <i class="menu-icon fa fa-list"></i>
                    <span class="menu-text"> Adjustment Info </span>
                    <b class="arrow fa fa-angle-down"></b>
                </a>
                ...
                <ul class="submenu">
                    ...
                    <?php if (array_search("adjustmentEntry", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
                        <li class="">
                            <a href="<?php echo base_url(); ?>adjustmentEntry">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Adjustment Entry
                            </a>
                            <b class="arrow"></b>
                    ...
                    <?php if (array_search("adjustmentList", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
                        <li class="">
                            <a href="<?php echo base_url(); ?>adjustmentList">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Adjustment List
                            </a>
                            <b class="arrow"></b>
        ...
        <?php if (
            array_search("customerEntry", $access) > -1
            ...
            <li class="">
                ...
                <ul class="submenu">
                    <?php if (array_search("customerEntry", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
                        <li class="">
...
<?php } elseif ($module == 'SalesModule') { ?>
    <ul class="nav nav-list">
        ...
        <?php if (array_search("salesPending", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <li class="">
                <a href="<?php echo base_url(); ?>salesPending">
                    <i class="menu-icon fa fa-list"></i>
                    <span class="menu-text"> Sales Pending </span>
                </a>
                <b class="arrow"></b>
            </li>
        <?php endif; ?>
...
<?php } elseif ($module == 'PurchaseModule') { ?>
    <ul class="nav nav-list">
        ...
        <?php if (array_search("purchasePendingRecord", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <li class="">
                <a href="<?php echo base_url(); ?>purchasePendingRecord">
                    <i class="menu-icon fa fa-list"></i>
                    <span class="menu-text">Purchase Pending </span>
                </a>
                <b class="arrow"></b>
            </li>
        <?php endif; ?>
...
<?php } elseif ($module == 'AccountsModule') { ?>
    <ul class="nav nav-list">
        ...
        <?php endif; ?>
        <?php if (array_search("customerPaymentPageExcel", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <li class="">
                <a href="<?php echo base_url(); ?>customerPaymentPageExcel">
                    <i class="menu-icon fa fa-money"></i>
                    <span class="menu-text"> Cus. Payment Excel</span>
                </a>
                <b class="arrow"></b>
            </li>
        <?php endif; ?>
