...
class Sales extends CI_Controller
{
    ...
    function salesPending()
    {
        ...
        $data['title'] = "Sales Record";
        $data['content'] = $this->load->view('Administrator/sales/sales_pending_record', $data, TRUE);
        $this->load->view('Administrator/index', $data);
    }
...
<?php
    ...
    public function approveSales()
    {
        ...
        try {
            ...
            $this->db->set('ApproveBy', $this->session->userdata("FullName"))->where('SaleMaster_SlNo', $data->saleId)->update('tbl_salesmaster');
